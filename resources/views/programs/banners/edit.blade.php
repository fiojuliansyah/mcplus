...
<div class="dashboard-main-body">
    ...
    <div class="row gy-4">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('program.banners.update', ['slug' => $program->slug, 'id' => $banner->id]) }}" method="POST" class="row gy-3" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="col-md-6">
                            ...
                            <div>
                                <img src="{{ $banner->image_url }}" class="img-thumbnail" width="200">
                            </div>
                        </div>
