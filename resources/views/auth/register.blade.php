        ...
        <div class="max-w-464-px mx-auto w-100">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="icon-field mb-16">
                    ...
                    <input id="name" type="text" class="form-control h-56-px bg-neutral-50 radius-12" name="name" value="{{ old('name') }}" required autofocus placeholder="Username">
                </div>
                ...
                <div class="icon-field mb-16">
                    ...
                    <input id="email" type="email" class="form-control h-56-px bg-neutral-50 radius-12" name="email" value="{{ old('email') }}" required autocomplete="email" placeholder="Email">
                </div>
                ...
                <div class="mb-20">
                    <div class="position-relative">
                        <div class="icon-field">
                            ...
                            <input id="password" type="password" class="form-control h-56-px bg-neutral-50 radius-12" name="password" required autocomplete="new-password" placeholder="Password">
                        </div>
                ...
                <div class="mb-20">
                    <div class="icon-field">
                        ...
                        <input id="password_confirmation" type="password" class="form-control h-56-px bg-neutral-50 radius-12" name="password_confirmation" required autocomplete="new-password" placeholder="Confirm Password">
                    </div>
                </div>
