...
<head>
    ...
    <!-- Title -->
    <title> McPlus - The Biggest Online Tuition</title>
    <!-- Favicon -->
...
<!--==================== Preloader Start ====================-->
  <div class="preloader">
    <img src="/frontend/assets/images/icons/preloader.gif" alt="">
  </div>
<!--==================== Preloader End ====================-->
...
<section class="breadcrumb py-120 bg-main-25 position-relative z-1 overflow-hidden mb-0">
    <img src="/frontend/assets/images/shapes/shape1.png" alt="" class="shape one animation-rotation d-md-block d-none">
    <img src="/frontend/assets/images/shapes/shape2.png" alt="" class="shape two animation-scalation d-md-block d-none">
    <img src="/frontend/assets/images/shapes/shape3.png" alt="" class="shape eight animation-walking d-md-block d-none">
    <img src="/frontend/assets/images/shapes/shape5.png" alt="" class="shape six animation-walking d-md-block d-none">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="breadcrumb__wrapper">
                    <h1 class="breadcrumb__title display-4 fw-semibold text-center"> Premium Tutors</h1>
                    <ul class="breadcrumb__list d-flex align-items-center justify-content-center gap-4">
                        ...
                        <li class="breadcrumb__item"> 
                            <span class="text-main-two-600"> Premium Tutors </span> 
                        </li>
                    </ul>
                </div>
            </div>
...
<!-- ==================== Breadcrumb End Here ==================== -->
    ...
    <!-- ============================== Tutor Section Start ============================== -->
    <section class="course-list-view py-120 background-img bg-img" data-background-image="/frontend/assets/images/bg/gradient-bg.png">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <div class="sidebar rounded-12 bg-white p-32 box-shadow-md">
                        <form action="#">
                            ...
                            <div class="position-relative">
                                <input type="text" class="common-input pe-48 rounded-pill bg-main-25" placeholder="Enter Your Email...">
                            ...
                            <div class="d-flex flex-column gap-32">
                                <div class="">
                                    <h6 class="text-lg mb-24 fw-semibold">Tutor Type</h6>
                                    <div class="d-flex flex-column gap-16">
                                        <div class="form-check common-check mb-0">
                                            <input class="form-check-input bg-main-25" type="checkbox" name="tutorType" id="AllTutors">
                                            <label class="form-check-label fw-normal flex-grow-1" for="AllTutors">All Tutors</label>
                                        </div>
                                        <div class="form-check common-check mb-0">
                                            <input class="form-check-input bg-main-25" type="checkbox" name="tutorType" id="Premiums">
                                            <label class="form-check-label fw-normal flex-grow-1" for="Premiums">Premiums</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="">
                                    <h6 class="text-lg mb-24 fw-semibold">Gender</h6>
                                    <div class="d-flex flex-column gap-16">
                                        <div class="form-check common-check mb-0">
                                            <input class="form-check-input bg-main-25" type="checkbox" name="tutorType" id="Male">
                                            <label class="form-check-label fw-normal flex-grow-1" for="Male">Male</label>
                                        </div>
                                        <div class="form-check common-check mb-0">
                                            <input class="form-check-input bg-main-25" type="checkbox" name="tutorType" id="Female">
                                            <label class="form-check-label fw-normal flex-grow-1" for="Female">Female</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="">
                                    <h6 class="text-lg mb-24 fw-semibold">Tuition Type</h6>
                                    <div class="d-flex flex-column gap-16">
                                        <div class="form-check common-check mb-0">
                                            <input class="form-check-input bg-main-25" type="checkbox" name="tutorType" id="Home">
                                            <label class="form-check-label fw-normal flex-grow-1" for="Home">Home</label>
                                        </div>
                                        <div class="form-check common-check mb-0">
                                            <input class="form-check-input bg-main-25" type="checkbox" name="tutorType" id="Online">
                                            <label class="form-check-label fw-normal flex-grow-1" for="Online">Online</label>
                                        </div>
                                        <div class="form-check common-check mb-0">
                                            <input class="form-check-input bg-main-25" type="checkbox" name="tutorType" id="Package">
                                            <label class="form-check-label fw-normal flex-grow-1" for="Package">Package</label>
                                        </div>
                                        <div class="form-check common-check mb-0">
                                            <input class="form-check-input bg-main-25" type="checkbox" name="tutorType" id="Group">
                                            <label class="form-check-label fw-normal flex-grow-1" for="Group">Group</label>
                                        </div>
                                        <div class="form-check common-check mb-0">
                                            <input class="form-check-input bg-main-25" type="checkbox" name="tutorType" id="School">
                                            <label class="form-check-label fw-normal flex-grow-1" for="School">School</label>
                                        </div>
                                        <div class="form-check common-check mb-0">
                                            <input class="form-check-input bg-main-25" type="checkbox" name="tutorType" id="Collage">
                                            <label class="form-check-label fw-normal flex-grow-1" for="Collage">Collage</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="">
                                    <h6 class="text-lg mb-20 fw-medium">Pricing scale</h6>
                                ...
                                <div class="">
                                    <h6 class="text-lg mb-20 fw-medium">Star Category</h6>
                                    <div class="d-flex flex-column gap-16">
                                ...
                                <div class="">
                                    <h6 class="text-lg mb-20 fw-medium">Location</h6>
                                    <input type="text" class="common-input border-transparent rounded-pill focus-border-main-600 bg-main-25" placeholder="Enter location...">
                                </div>
                                <div class="">
                                    <h6 class="text-lg mb-20 fw-medium">Select Country</h6>
                                    <select class="common-input form-select border-transparent rounded-pill focus-border-main-600 bg-main-25">
                                ...
                                <div class="">
                                    <h6 class="text-lg mb-20 fw-medium">Select Language</h6>
                                    <select class="common-input form-select border-transparent rounded-pill focus-border-main-600 bg-main-25">
                                ...
                                <div class="">
                                    <h6 class="text-lg mb-20 fw-medium">Select Department </h6>
                                    <select class="common-input form-select border-transparent rounded-pill focus-border-main-600 bg-main-25">
                                        <option value="1">English</option>
                                        <option value="1">Bangla</option>
                                ...
                                <div class="">
                                    <h6 class="text-lg mb-20 fw-medium">Select Subject</h6>
                                    <select class="common-input form-select border-transparent rounded-pill focus-border-main-600 bg-main-25">
                                        <option value="1">English</option>
                                        <option value="1">Bangla</option>
                                        <option value="1">Economics</option>
                    ...
                    <div class="row gy-4">
                            ...
                            <div class="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div class="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative">
                                    <a href="tutor-details.html" class="w-100 h-100">
                                        <img src="/frontend/assets/images/thumbs/instructor-img1.png" alt="Course Image" class="scale-hover-item__img rounded-12 cover-img transition-2">
                                    </a>
                                </div>
                        ...
                        <div class="col-sm-6">
                            <div class="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div class="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative">
                                    <a href="tutor-details.html" class="w-100 h-100">
                                        <img src="/frontend/assets/images/thumbs/instructor-img2.png" alt="Course Image" class="scale-hover-item__img rounded-12 cover-img transition-2">
                                    </a>
                                </div>
                                <div class="pt-32 pb-24 px-16 position-relative">
                                    <div class="">
                        ...
                        <div class="col-sm-6">
                            <div class="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div class="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative">
                                    <a href="tutor-details.html" class="w-100 h-100">
                                        <img src="/frontend/assets/images/thumbs/instructor-img3.png" alt="Course Image" class="scale-hover-item__img rounded-12 cover-img transition-2">
                                    </a>
                                </div>
                                <div class="pt-32 pb-24 px-16 position-relative">
                                    <div class="">
                        ...
                        <div class="col-sm-6">
                            <div class="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div class="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative">
                                    <a href="tutor-details.html" class="w-100 h-100">
                                        <img src="/frontend/assets/images/thumbs/instructor-img4.png" alt="Course Image" class="scale-hover-item__img rounded-12 cover-img transition-2">
                                    </a>
                                </div>
                                <div class="pt-32 pb-24 px-16 position-relative">
                                    <div class="">
                        ...
                        <div class="col-sm-6">
                            <div class="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div class="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative">
                                    <a href="tutor-details.html" class="w-100 h-100">
                                        <img src="/frontend/assets/images/thumbs/instructor-img5.png" alt="Course Image" class="scale-hover-item__img rounded-12 cover-img transition-2">
                                    </a>
                                </div>
                                <div class="pt-32 pb-24 px-16 position-relative">
                                    <div class="">
                                        <h4 class="mb-16">
                                            <a href="tutor-details.html" class="link text-line-2">Wade Warren</a>
                                        </h4>
                                        <div class="flex-between gap-8 flex-wrap">
                                            <div class="flex-align gap-12">
                                                <span class="text-2xl text-main-600 d-flex"><i class="ph-bold ph-graduation-cap"></i></span>
                                                <span class="">GFC University</span>
                                            </div>
                                            <div class="flex-align gap-4">
                                                <span class="text-2xl fw-medium text-warning-600 d-flex"><i class="ph-fill ph-star"></i></span>
                                                <span class="text-lg text-neutral-700">
                        ...
                        <div class="col-sm-6">
                            <div class="scale-hover-item bg-white rounded-16 p-12 h-100 box-shadow-md">
                                <div class="course-item__thumb rounded-12 bg-main-25 overflow-hidden position-relative">
                                    <a href="tutor-details.html" class="w-100 h-100">
                                        <img src="/frontend/assets/images/thumbs/instructor-img6.png" alt="Course Image" class="scale-hover-item__img rounded-12 cover-img transition-2">
                                    </a>
                                </div>
                                <div class="pt-32 pb-24 px-16 position-relative">
                                    <div class="">
                                        <h4 class="mb-16">
                                            <a href="tutor-details.html" class="link text-line-2">Dianne Russell</a>
                                        </h4>
                                        <div class="flex-between gap-8 flex-wrap">
                                            <div class="flex-align gap-12">
                                                <span class="text-2xl text-main-600 d-flex"><i class="ph-bold ph-graduation-cap"></i></span>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-6 d-xl-block d-none">
                            <div class="certificate__thumb" data-aos="fade-up-left">    
                                <img src="/frontend/assets/images/thumbs/certificate-img.png" alt="" data-tilt data-tilt-max="8" data-tilt-speed="500" data-tilt-perspective="5000" data-tilt-full-page-listening>
                            </div>
                        </div>
                    </div>
                </div>
