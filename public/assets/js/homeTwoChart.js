  ...
  createChart('new-user-chart', '#c40248');
  ...
  createChartTwo('revenue-chart', '#c40248');
  ...
  // ================================ Earning Statistics bar chart Start ================================ 
    var options = {
      ...
      fill: {
          type: 'gradient',
          colors: ['#c40248'], // Set the starting color (top color) here
          gradient: {
              shade: 'light', // Gradient shading type
              type: 'vertical',  // Gradient direction (vertical)
              shadeIntensity: 0.5, // Intensity of the gradient shading
              gradientToColors: ['#c40248'], // Bottom gradient color (with transparency)
              inverseColors: false, // Do not invert colors
