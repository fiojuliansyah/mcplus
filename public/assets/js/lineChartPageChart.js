  ...
  createChartTwo('zoomAbleLineChart', '#c40248');
  // =========================== Zoom able Line Chart End ===============================
  ...
  // =========================== Line Chart With Data labels Start ===============================
    var options = {
        ...
        colors: ['#c40248'],  // Set the color of the series
        dataLabels: {
          enabled: true
        },
        stroke: {
  ...
  function createLineChart(chartId, chartColor) {
    var options = {
      ...
      colors: ['#c40248', '#FF9F29'],  // Set the color of the series
      dataLabels: {
          enabled: false
      },
      stroke: {
  ...
  createLineChart('doubleLineChart', '#c40248');
